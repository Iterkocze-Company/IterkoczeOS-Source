...
#define PACKAGE_BUGREPORT "https://bugzilla.xfce.org/enter_bug.cgi?product=Xfce4-notifyd"

/* Define to the full name of this package. */
#define PACKAGE_NAME "xfce4-notifyd"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "xfce4-notifyd 0.6.2"
...
/* #undef USE_OLD_GET_SERVER_INFORMATION_SIGNATURE */

/* Set if we should use the old NotificationClosed signal signature */
/* #undef USE_OLD_NOTIFICATION_CHANGED_SIGNATURE */
